...
import { describeBlocks, loadTemplateBlocks, loadTemplatePictures } from '../factory/texts/template.mjs';
...
// The same tree, for the file that replaces blocks.json in v2.
...
// What blocks.json carried that an example cannot say: where a picture goes, and how many links a
// block may hold. Everything else about a page is read off the example now (factory/texts/example.mjs).
